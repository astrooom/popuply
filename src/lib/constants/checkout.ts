...
export const PRODUCTS = [
  ...
  { id: "5sites", name: "5 Sites", price: 20, sites: 5, pricingId: "price_1Pxsl9CbIUymC3Vf8riz4rDZ" },
  { id: "10sites", name: "10 Sites", price: 30, sites: 10, pricingId: "price_1PxzcyCbIUymC3VfGckzhA55" },
]

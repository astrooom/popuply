...
const ACCEPTED_IMAGE_TYPES = [
  ...ACCEPTED_IMAGE_EXTENSIONS.map(extension => `image/${extension}`),
  "image/svg+xml"
];
  ...
  return (
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className={className} onBlur={handleFormBlur}>
        ...
        <Card className={cn("p-2 h-full rounded-xl relative shadow-md lg:w-[370px]", popup?.theme === "dark" ? "bg-[#333333]" : "bg-white")}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input variant="ghost" className={cn("border-0 h-6 text-[14px] font-semibold", popup?.theme === "dark" ? "bg-[#333333] text-white placeholder:text-white/70" : "bg-white text-black")} placeholder="Title" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input variant="ghost" className={cn("border-0 h-6 text-[13px]", popup?.theme === "dark" ? "bg-[#333333] text-white placeholder:text-white/70" : "bg-white text-black")} placeholder="Content" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormControl>
                  <Input
                    className={cn(
                      ...
                      popup?.theme === "dark" ? "bg-transparent text-white/70 placeholder:text-white/50" : "bg-white text-black/70 placeholder:text-black/50",
                    )}
                    variant="ghost"
              ...
              <FormItem>
                <FormControl>
                  <div>
                    ...
                    >
                      {field.value === "light" ? <SunMoonIcon className="w-[15px] h-[15px]" /> : <MoonIcon className="w-[15px] h-[15px] " />}
                    </Button>

...
export function Site({ site }: { site: SiteType }) {
  return (
    <TableRow>
      ...
      <TableCell>{site?.visitors == null ? "Unknown" : site.visitors < 1000 ? site.visitors : new Intl.NumberFormat('en', { notation: 'compact' }).format(site.visitors)}</TableCell>
      <TableCell>
      ...
      <CardHeader className="flex flex-row items-center pb-2">
        {site.faviconUrl && (
          <Image
            ...
            width={32}
            height={32}
            className="rounded-full lg:inline hidden"
          />
        )}
